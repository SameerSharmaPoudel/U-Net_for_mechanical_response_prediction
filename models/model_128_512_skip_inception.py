...
class Encoder(Module):
    def __init__(self,**kwargs):
        ...
        self.down_conv_6 = Inception_block(128, 64, 80, 128, 20, 32, 32)
        self.down_conv_7 = Inception_block(256, 128, 160, 256, 40, 64, 64)
    ...
    def forward(self, x):
        ...
        x11 = self.pool(x11)
        #print(x11.shape)
        x11 = self.down_conv_7(x11)
        #print(x11.shape)
        encoded = self.pool(x11)
        #print(encoded.shape)
...
class Decoder(Module):
    def __init__(self,**kwargs):
        ...
        #Decoder
        #self.conv = Inception_block(512, 128, 256, 256, 64, 64, 64)
        self.latent_conv = Conv2d(512,512,1)
        self.t_conv0 = up_conv(512, 512)
        self.conv0 = Inception_block(512, 128, 256, 256, 64, 64, 64)
        self.t_conv1 = up_conv(512, 256)
