...
class Decoder(Module):
    def __init__(self,**kwargs):
        ...
        self.conv1 = Conv2d(256, 256, kernel_size=3, stride=1)
        self.t_conv2 = up_conv(256, 128)
        self.conv2 = Conv2d(128, 128, kernel_size=3, stride=1)
        self.t_conv3 = up_conv(128, 64)
        self.conv3 = Conv2d(64, 64, kernel_size=3, stride=1)
        self.t_conv4 = up_conv(64,32)
        self.conv4 = Conv2d(64, 32, kernel_size=3, stride=1)
        self.t_conv5 = up_conv(32,16)
        self.conv5 = Conv2d(32, 16, kernel_size=3, stride=1)
        self.t_conv6 = up_conv(16, 8)
        self.out = Conv2d(8, 2, 1)
        
        self.skip2 = Conv2d(1, 32, kernel_size=3, stride=1)
        self.skip1 = Conv2d(1, 16, kernel_size=3, stride=1)
    ...
    def forward(self, x, x1, x2):
        ...
        #print(x16.shape)
        x2 =  F.pad(x2, pad=(1, 1, 1, 1), mode='circular')
        x2 = self.skip2(x2)
        #print(x2.shape)
        ...
        #print(x17.shape)
        x1 = F.pad(x1, pad=(1, 1, 1, 1), mode='circular')
        x1 = self.skip1(x1)
